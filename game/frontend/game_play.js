...
var make_spectator_intf = function() {
  ...
  window.fps_range.style.display = 'none';
  ...
  window.button_faster.style.display = 'none';
  window.button_slower = addButton("Slower", "W");
  window.button_slower.style.display = 'none';
  window.button_cycle = addButton("Cycle", "C");
  window.button_cycle.style.display = 'none';
  window.button_pause = addButton("Pause", "P");
  window.button_pause.style.display = 'none';
  window.toggle_fow = function (){
    if (window.fow) {
  ...
  window.progress_range.style.display = 'none';
  ...
  document.getElementById("cmd_input_label").innerHTML = "Current command to execute on:";
